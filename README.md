...
[![Innoveto](https://img.shields.io/badge/Kurs-Innoveto-blue)](https://innoveto.com)
...
```mermaid
flowchart TD
    Start([Deine Startup-Idee]) --> Day1

    subgraph Day1["Tag 1: Von der Idee zum Produkt"]
        direction TB
        R01["01 Kontext schlägt Prompt"]
        R02["02 AI als Sparring-Partner"]
        R03["03 Von der Idee zum Text"]
        R04["04 Visuelle Identität"]
        R05["05 Landing Page"]
        R01 --> R02 --> R03 --> R04 --> R05
    end
    ...
    subgraph Day2["Tag 2: Marketing & Automatisierung"]
        direction TB
        R06["06 Marktanalyse"]
        R07["07 Social Media Content"]
        R08["08 Video & Multimedia"]
        R09["09 Automatisieren"]
        R10["10 Dein Prompt-Playbook"]
        R06 --> R07 --> R08 --> R09 --> R10
    end

    Day2 --> End(["Fertiges Startup"])
```
